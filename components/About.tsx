...
const About = (props: Props) => {
  return (
    ...
    >
      <h3 className="absolute top-12 xl:top-24 uppercase ml-7 tracking-[20px] text-gray-500 text-2xl text-center">
        About
      </h3>
      <motion.img
        initial={{
        ...
        viewport={{ once: true }}
        className="-mb-20 mt-10 md:mb-0 hidden xl:block md:block flex-shrink-0 w-40 h-40 rounded-full object-cover md:rounded-lg md:w-64 md:h-95 xl:w-[400px] xl:h-[450px]"
